...
cap = cv2.VideoCapture(0 ,cv2.CAP_DSHOW) # Chnage this to capture from different sources, 0 is webcam.
...
while ret:
    ...
    # Display the FPS value on the frame
    cv2.putText(frame, f"FPS: {fps}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

    # plot results
    frame = cv2.resize(frame, (1280, 720))  # Replace width and height with desired values
